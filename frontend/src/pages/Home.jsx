...
export default function Home() {
  ...
  return (
    <main id="main-content" role="main">
      <div style={{ background: 'var(--blue-france)', color: 'white', padding: '4rem 1.5rem' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.85)', maxWidth: 560, marginBottom: 32 }}>
      ...
      <div style={{ background: 'var(--red-marianne)', color: 'white', padding: '12px 1.5rem', textAlign: 'center' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '3rem 1.5rem' }}>
        ...
        {menus.length > 0 && (
          <section aria-labelledby="infos-title" style={{ marginTop: '3rem' }}>
            ...
            <ul style={{ display: 'flex', gap: 12, flexWrap: 'wrap', listStyle: 'none' }}>
              {menus.map(menu => (
                <li key={menu.id}>
...
const linkArrow = { color: 'var(--blue-france)', fontWeight: 600, fontSize: 14, textDecoration: 'underline' };